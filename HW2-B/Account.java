...
class Account {
    ...
    LinkedList<Account> followers = new LinkedList<Account>();
    LinkedList<Account> following =  new LinkedList<Account>();
    private LinkedList<Post> post;
    private LinkedList<Message> inbox;
    private LinkedList<Message> outbox;
    private boolean login_status = false;
    private LinkedList<Account> blockedid = new LinkedList<Account>();
    ...
    public LinkedList<Action> getActionHistory()
    {
